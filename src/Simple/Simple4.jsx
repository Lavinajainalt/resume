...
const Simple4 = () => {
  ...
  const downloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const resume = document.getElementById('resume-preview3');
      if (!resume) return;
  ...
  const ResumePreview = memo(({ data }) => (
    <div id="resume-preview3" className="resume3">
      <header className="header3">
        <h1>{data.fullName || 'Your Name'}</h1>
        <h2 className="title3">{data.title || 'Professional Title'}</h2>
        <ContactInfo {...data} />
      </header>

      {data.summary && (
        <section className="summary3">
      ...
      <div className="two-column3">
        {data.skills && (
          <section className="skills3">
            <h2>Skills</h2>
            <div className="content3">
              {data.skills.split('\n').map((skill, index) => (
        ...
        <div className="right-column3">
          ...
          {data.certifications && (
            <section className="certifications3">
  ...
  const ResumeForm = memo(({ formData, handleChange }) => (
    <div className="form-section3">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="form3">
        <FormInput 
          label="Full Name" 
          name="fullName" 
